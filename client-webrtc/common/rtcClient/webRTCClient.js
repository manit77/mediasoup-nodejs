...
class WebRTCClient {
    ...
    createOffer(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const offer = yield remote.pc.createOffer();
            yield remote.pc.setLocalDescription(offer);
            return offer;
        });
    }
    /**
    ...
    createAnswer(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const answer = yield remote.pc.createAnswer();
            yield remote.pc.setLocalDescription(answer);
    ...
    setRemoteDescription(key, desc) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield remote.pc.setRemoteDescription(new RTCSessionDescription(desc));
        });
    }
    /***
     * add ice candidate
     */
    addIceCandidate(key, candidate) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield remote.pc.addIceCandidate(new RTCIceCandidate(candidate));
        });
    }
}
