(() => {
    ...
    "common/conferenceSharedModels.ts"() {
      ConferenceConfig = class {
        constructor() {
          ...
          this.type = "p2p" /* p2p */;
          //p2p is using p2p webrtc calls, room is using sfu conferencing
          /**
  ...
  // common/rtcClient/webRTCClient.ts
  var WebRTCClient;
  ...
  // common/roomsClient/roomSharedModels.ts
  var RegisterMsg2, CreateProducerTransportMsg, ConnectProducerTransportMsg, CreateConsumerTransportMsg, ConnectConsumerTransportMsg, RoomJoinMsg, RoomLeaveMsg, ProduceMsg, ConsumeMsg;
