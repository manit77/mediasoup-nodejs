...
(() => {
  ...
  // payload.ts
  var RegisterMsg, CreateProducerTransportMsg, ConnectProducerTransportMsg, CreateConsumerTransportMsg, ConnectConsumerTransportMsg, RoomJoinMsg, ProducedMsg, ConsumeMsg;
  var init_payload = __esm({
    "payload.ts"() {
      ...
      ProducedMsg = class {
        constructor() {
          this.type = "produced" /* produced */;
        }
      };
      ConsumeMsg = class {
        constructor() {
          this.action = "consume" /* consume */;
        }
      };
    }
  });
  ...
  var require_main = __commonJS({
    "main.ts"() {
      ...
      (async () => {
        ...
        await initWebsocket();
        async function createVideoElement(peerId, track) {
