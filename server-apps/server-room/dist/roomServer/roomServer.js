...
export class RoomServer {
     ...
     * @returns
     */
    createPeer(authToken, displayName) {
    ...
    async createRoom(roomId, roomToken, config) {
    ...
    async onCreateProducerTransport(peerId, msgIn) {
    ...
    async onCreateConsumerTransport(peerId, msgIn) {
    ...
    async onConnectProducerTransport(peerId, msgIn) {
    ...
    async onConnectConsumerTransport(peerId, msgIn) {
     ...
     */
    async onRoomNewToken(peerId, msgIn) {
    ...
    async onAuthUserNewTokenMsg(msgIn) {
    ...
    async onRoomJoin(peerId, msgIn) {
        ...
        let room = this.rooms.get(msgIn.data.roomId);
        if (room) {
