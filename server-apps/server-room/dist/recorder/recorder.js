...
export async function startRecordingAudio(recordingsDir, peer, router) {
...
export async function startRecordingVideo(recordingsDir, peer, router) {
...
export async function stopRecording(peer, id) {
