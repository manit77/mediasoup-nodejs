...
export class Participant {
    constructor() {
        this.participantId = ""; //generated by server to keep track of connections
        this.userName = ""; //username for the user, unique, used to login ie from a database
        this.displayName = ""; //display name for the user
        this.socket = undefined; //websocket connection
        this.conferenceRoom = undefined; //reference to a conf room
    }
}
export class ConferenceRoom {
    constructor() {
        this.conferenceToken = ""; //provided by our conferencing server    
        this.participants = [];
        this.isClosed = false;
        // configs
        this.config = new ConferenceConfig();
        this.roomToken = ""; //provided by the rooms server
        // Timers
        this.timerIdMaxDuration = undefined;
        //executes when room is created and no participants has joined
        this.timerIdNoParticipants = undefined;
    }
    get confType() {
