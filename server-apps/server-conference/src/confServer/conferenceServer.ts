...
import {
    ...
    , InviteMsg, InviteResultMsg, LeaveMsg
    , RegisterMsg, RegisterResultMsg
    , RejectMsg
...
export class ConferenceServer {
    ...
    constructor(c: ConferenceServerConfig, private app: express.Express, private httpServer: https.Server) {
    ...
    async start() {
        ...
        this.app.post("/onRoomClosed", (req, res) => {

        });

        this.app.post("/onPeerJoined", (req, res) => {

        });

        this.app.post("/onPeerLeft", (req, res) => {
