...
import {
    ...
    , ProducerTransportCreatedMsg, RegisterPeerMsg, RegisterPeerResultMsg, RoomJoinMsg, RoomJoinResultMsg, RoomLeaveMsg
...
(async () => {
    ...
    async function onRegisterResult(msgIn: RegisterPeerResultMsg) {
