...
// ../../packages/shared-models/conf-models/dist/conferenceSharedModels.js
var ConferenceType;
(function(ConferenceType2) {
  ConferenceType2["p2p"] = "p2p";
  ConferenceType2["rooms"] = "rooms";
})(ConferenceType || (ConferenceType = {}));
var CallMessageType;
(function(CallMessageType2) {
  CallMessageType2["login"] = "login";
  CallMessageType2["register"] = "register";
  CallMessageType2["registerResult"] = "registerResult";
  CallMessageType2["newConference"] = "newConference";
  CallMessageType2["newConferenceResult"] = "newConferenceResult";
  CallMessageType2["invite"] = "invite";
  CallMessageType2["inviteResult"] = "inviteResult";
  CallMessageType2["reject"] = "reject";
  CallMessageType2["join"] = "join";
  CallMessageType2["joinResult"] = "joinResult";
  CallMessageType2["leave"] = "leave";
  CallMessageType2["newParticipant"] = "newParticipant";
  CallMessageType2["participantLeft"] = "participantLeft";
  CallMessageType2["conferenceClosed"] = "conferenceClosed";
  CallMessageType2["closeConference"] = "closeConference";
  CallMessageType2["getContacts"] = "getContacts";
  CallMessageType2["reconnect"] = "reconnect";
  CallMessageType2["reconnectResult"] = "reconnectResult";
  CallMessageType2["participantReconnected"] = "participantReconnected";
  CallMessageType2["rtc_needOffer"] = "rtc_needOffer";
  CallMessageType2["rtc_offer"] = "rtc_offer";
  CallMessageType2["rtc_answer"] = "rtc_answer";
  CallMessageType2["rtc_ice"] = "rtc_ice";
})(CallMessageType || (CallMessageType = {}));
var ConferenceConfig = class {
  constructor() {
    ...
    this.type = ConferenceType.p2p;
    this.timeOutNoParticipantsSecs = 3e4;
    this.timeOutMaxDurationSecs = 36e5;
    this.leaderUserName = "";
    this.closeConferenceOnLeaderExit = false;
    this.expiresIn = 0;
  }
};
var RegisterMsg = class {
  constructor() {
...
// ../../packages/client-libs/websocket-client/dist/webSocketManager.js
...
// ../../packages/client-libs/webrtc-client/dist/webRTCClient.js
...
// ../../packages/client-libs/rooms-client/src/roomsClient.ts
var mediasoupClient = __toESM(require_lib5());

// ../../packages/shared-models/rooms-models/dist/roomsSharedModels.js
var payloadTypeClient;
(function(payloadTypeClient2) {
  payloadTypeClient2["authUserNewToken"] = "authUserNewToken";
  payloadTypeClient2["registerPeer"] = "registerPeer";
  payloadTypeClient2["terminatePeer"] = "terminatePeer";
  payloadTypeClient2["createProducerTransport"] = "createProducerTransport";
  payloadTypeClient2["createConsumerTransport"] = "createConsumerTransport";
  payloadTypeClient2["connectProducerTransport"] = "connectProducerTransport";
  payloadTypeClient2["connectConsumerTransport"] = "connectConsumerTransport";
  payloadTypeClient2["roomNewToken"] = "roomNewToken";
  payloadTypeClient2["roomNewTokenResult"] = "roomNewTokenResult";
  payloadTypeClient2["roomNew"] = "roomNew";
  payloadTypeClient2["roomJoin"] = "roomJoin";
  payloadTypeClient2["roomLeave"] = "roomLeave";
  payloadTypeClient2["roomTerminate"] = "roomTerminate";
  payloadTypeClient2["roomTerminateResult"] = "roomTerminateResult";
  payloadTypeClient2["produce"] = "produce";
  payloadTypeClient2["consume"] = "consume";
})(payloadTypeClient || (payloadTypeClient = {}));
var payloadTypeServer;
(function(payloadTypeServer2) {
  payloadTypeServer2["authUserNewTokenResult"] = "authUserNewTokenResult";
  payloadTypeServer2["registerPeerResult"] = "registerPeerResult";
  payloadTypeServer2["producerTransportCreated"] = "producerTransportCreated";
  payloadTypeServer2["consumerTransportCreated"] = "consumerTransportCreated";
  payloadTypeServer2["produced"] = "produced";
  payloadTypeServer2["consumed"] = "consumed";
  payloadTypeServer2["unauthorized"] = "";
  payloadTypeServer2["roomNewResult"] = "roomNewResult";
  payloadTypeServer2["roomNewTokenResult"] = "roomNewTokenResult";
  payloadTypeServer2["roomJoinResult"] = "roomJoinResult";
  payloadTypeServer2["roomLeaveResult"] = "roomLeaveResult";
  payloadTypeServer2["roomNewPeer"] = "roomNewPeer";
  payloadTypeServer2["roomNewProducer"] = "roomNewProducer";
  payloadTypeServer2["roomPeerLeft"] = "roomPeerLeft";
  payloadTypeServer2["roomTerminate"] = "roomTerminate";
  payloadTypeServer2["peerTerminated"] = "peerTerminated";
})(payloadTypeServer || (payloadTypeServer = {}));
var RegisterPeerMsg = class {
  constructor() {
    this.type = payloadTypeClient.registerPeer;
    this.data = {};
  }
};
var CreateProducerTransportMsg = class {
  constructor() {
    this.type = payloadTypeClient.createProducerTransport;
    this.data = {};
  }
};
var ConnectProducerTransportMsg = class {
  constructor() {
    this.type = payloadTypeClient.connectProducerTransport;
    this.data = {};
  }
};
var CreateConsumerTransportMsg = class {
  constructor() {
    this.type = payloadTypeClient.createConsumerTransport;
    this.data = {};
  }
};
var ConnectConsumerTransportMsg = class {
  constructor() {
    this.type = payloadTypeClient.connectConsumerTransport;
    this.data = {};
  }
};
var RoomJoinMsg = class {
  constructor() {
    this.type = payloadTypeClient.roomJoin;
    this.data = {};
  }
};
var RoomLeaveMsg = class {
  constructor() {
    this.type = payloadTypeClient.roomLeave;
    this.data = {};
  }
};
var ProduceMsg = class {
  constructor() {
    this.type = payloadTypeClient.produce;
    this.data = {};
  }
};
var ConsumeMsg = class {
  constructor() {
    this.type = payloadTypeClient.consume;
    this.data = {};
  }
};
var RoomServerAPIRoutes;
(function(RoomServerAPIRoutes2) {
  RoomServerAPIRoutes2["newAuthUserToken"] = "/newAuthUserToken";
  RoomServerAPIRoutes2["newRoomToken"] = "/newRoomToken";
  RoomServerAPIRoutes2["newRoom"] = "/newRoom";
  RoomServerAPIRoutes2["terminateRoom"] = "/terminateRoom";
...
var RoomsClient = class {
  ...
  */
  ...
  waitForRegister(trackingId, displayName) {
    return new Promise((resolve, reject) => {
      this.register(trackingId, displayName);
      let timerid = setTimeout(() => reject("failed to register"), 5e3);
  ...
  waitForRoomJoin(roomid, roomToken) {
    return new Promise((resolve, reject) => {
      this.roomJoin(roomid, roomToken);
      let timerid = setTimeout(() => reject("failed to join room"), 5e3);
      const onmessage = (event) => {
        let msgIn = JSON.parse(event.data);
        this.writeLog("-- onmessage", msgIn);
...
// ../../packages/client-libs/conf-client/dist/conferenceCallManager.js
var EventTypes;
(function(EventTypes2) {
  EventTypes2["registerResult"] = "registerResult";
  EventTypes2["inviteReceived"] = "inviteReceived";
  EventTypes2["inviteResult"] = "inviteResult";
  EventTypes2["rejectReceived"] = "rejectReceived";
  EventTypes2["connected"] = "connected";
  EventTypes2["disconnected"] = "disconnected";
  EventTypes2["joinResult"] = "joinResult";
  EventTypes2["newParticipant"] = "newParticipant";
  EventTypes2["participantLeft"] = "participantLeft";
  EventTypes2["contactsReceived"] = "contactsReceived";
  EventTypes2["confClosed"] = "confClosed";
})(EventTypes || (EventTypes = {}));
var ConferenceCallManager = class {
  constructor() {
  ...
  */
  ...
  async rooms_waitForConnection(roomURI) {
